  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] w-full rounded-lg overflow-hidden bg-surface-container transition-all duration-300 group-hover:scale-[1.05] group-hover:-translate-y-2 border border-outline-variant/10 card-hover-shadow">
        ...
        {/* Quick Hover Overlay */}
        <div className="absolute inset-0 bg-black/60 opacity-0 md:group-hover:opacity-100 transition-opacity duration-300 hidden md:flex flex-col items-center justify-center gap-3 z-10">
          <button
            onClick={handleToggleWatchlist}
            className={`px-4 py-2 rounded-full text-xs font-bold flex items-center gap-1.5 hover:scale-105 active:scale-95 cursor-pointer shadow-lg transform translate-y-3 opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-300 delay-[50ms] ${
              isInWatchlist 
          ...
          <div
            className="glass-panel text-white px-4 py-2 rounded-full text-xs font-bold flex items-center gap-1.5 hover:scale-105 active:scale-95 cursor-pointer shadow-lg hover:bg-white/10 transform translate-y-3 opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100 transition-all duration-300 delay-[120ms]"
          >
      ...
      <div className="flex flex-col gap-0.5 px-1 mt-1">
        ...
        <div className="flex items-center justify-between font-label-sm text-label-sm">
          ...
          <span className="text-on-surface-variant ml-auto">{year}</span>
        </div>
      </div>
    </Link>
  );
